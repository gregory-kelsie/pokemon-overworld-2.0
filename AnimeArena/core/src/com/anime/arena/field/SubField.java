...
public class SubField {
    ...
    public void activateMegaEvolution() {
        this.megaEvolved = true;
    }

    public void activateDynamax() {
        this.dynamaxed = true;
    }
    ...
    /**
     * Remove the SubField's entry hazards.
    ...
    /**
     * Return whether or not the SubField has any entry hazards.
     * @return Whether or not the SubField has any entry hazards.
     */
    public boolean hasEntryHazards() {
